...
public class AngleMap {
  // DATA
  public ArrayList<Integer> tsIframes = new ArrayList<>();   // ArrayList of Integer
  public ArrayList<Integer> tsJframes = new ArrayList<>();   // ArrayList of Integer
  ...
  // This method serializes the 1-1 angle map
  ...
  // This method deserializes the 1-1 angle map to a hashmap
  public static HashMap<Integer, Integer> deserializeToHashMap() {
    ...
    try {
      ...
      angleHashMap = (HashMap) ois.readObject();
      ois.close();
      fis.close();
  ...
  public static AngleMap deserializeToAngleMap(String fileName) {
    ...
    // This method shifts the indexes for the zeroes that were removed earlier to not mess up the indexes when we compare angles.
